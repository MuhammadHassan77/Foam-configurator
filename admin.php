    ...
    <body class="text-muted">
            ...
            <header class="navbar navbar-dark bg-light sticky-top flex-md-nowrap p-0 shadow">
                <a class="navbar-brand bg-light col-md-3 col-lg-2 me-0 p-0 d-flex justify-content-center " href="">
                    <img class="img-fluid" src="./img/logo.png" style="height:45px" alt="">
                </a>
                ...
                <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                    <div class="position-sticky pt-3">
                        ...
                        <h6 class="sidebar-heading d-flex justify-content-between align-items-center px-3 mt-4 mb-1 text-muted">
                            <a class="link-secondary w-100 navigator" href="#upload-tab" aria-label="Add a new report" style="text-decoration: none;">
                                <span>Upload Components</span>
                                <i class="fa fa-cloud-upload-alt float-end"></i>
                            </a>
                        </h6>
                    </div>
                </nav>
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-sm">
                                    ...
                                    <tbody>
                                        <?php
                                        $q = "SELECT *
                                        -- (SELECT url FROM saveurl WHERE saveurl.email=orders.email ) AS url
                                        FROM orders";
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td> <?php echo $url; ?>
                                                    <a class="text-muted text-decoration-none px-1" style="float:right" href="<?php echo $url; ?>" target="_blank"> <i class="fas fa-external-link-square-alt"></i> open</a></td>
                    ...
                    <div class="container-fluid tab d-none" id="upload-tab">
                        <div class="row m-2">
                            ...
                            <h2>Upload Foam Designs</h2>

                            <!-- FOAM DESIGN A-->
                            <form class="p-2" action="./admin.php" id="designAForm" method="post" enctype="multipart/form-data">
                                <div id="designANotify">
                                </div>
                                <div class="mb-3">
                                    <label for="designA" class="form-label">Upload Design A</label>
                                    <input class="form-control" type="file" id="designA" name="designA">
                                    <div class="form-text">Upload only PNG images.</div>
                                </div>
                            </form>

                            <!-- FOAM DESIGN B-->
                            <form class="p-2" action="./admin.php" id="designBForm" method="post" enctype="multipart/form-data">
                                <div id="designBNotify">
                                </div>
                                <div class="mb-3">
                                    <label for="designB" class="form-label">Upload Design B</label>
                                    <input class="form-control" type="file" id="designB" name="designB">
                                    <div class="form-text">Upload only PNG images.</div>
                                </div>
                            </form>
